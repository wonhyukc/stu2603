...
* **패스키(Passkey) 실습**: 패스키가 무엇인지 제미니(Gemini)에게 검색하여 공부한 후 소감 작성. 이후 자신의 스마트폰에 먼저 패스키를 등록하고, 학교 공용 컴퓨터에서 패스키를 사용하여 로그인해 봅니다. 메일에는 패스키를 사용한 화면의 스크린샷(100KB 이하)을 첨부하세요.
