...
**참조 파일**: `web-output/e-track-curriculum.md`
...
**현상**
`curriculum-qa-rubric.md` 영역 1-2는 "100% 한국어 작성"을 3점 만점 기준으로 삼는다. 그러나 현재 `e-track-curriculum.md`는 전체가 한국어/영어 Bilingual로 작성되어 있어, 루브릭 적용 시 1-2에서 자동으로 1점밖에 받지 못한다.
