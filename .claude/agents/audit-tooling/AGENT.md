...
- 주차별 폴더 내에 필수 하위 문서(`lecture.md`, `lecture-script.md`, `lab.md`, `homework.md`, `course-notice.md`)가 존재하는지 확인하세요.
- **중요**: 주차별 폴더 내부에 관리 문서(`CLAUDE.md`, `2todo.md`, `3history.md`, `4test.md`)가 **존재해서는 안 됩니다** (루트 문서 집중 원칙). 만약 있다면 위반으로 기록하세요.
