...
- **E트랙 (`wb**`) 필수 파일**: `lecture.md`, `lecture-script.md`, `handout.md`, `peer-eval-lubric.md`
- **K트랙 (`py**`) 필수 파일**: `lecture.md`, `lecture-script.md`, `handout.md`, `peer-eval-lubric.md`, `lab.ipynb`
...
| web-output/웹프로그래밍(E트랙)_교육안.md | [O/X] | [PASS/FAIL] |
| python-output/컴퓨팅적사고와코딩(K트랙)_교육안.md | [O/X] | [PASS/FAIL] |
| python-output/교육안_QA_루브릭.md | [O/X] | [PASS/FAIL] |
