...
# 에코시스템 및 문서 구조 감사 지침 (audit-structure)
...
- `CLAUDE.md`
- `README.md`
- `web-output/web-curriculum.md`
- `python-output/python-curriculum.md`
- `python-output/curriculum-qa-rubric.md`

### 2. 하위 디렉토리(주차별 폴더) 구조 검증

- **E트랙 (`wb**`) 필수 파일**: `lecture.md`, `lecture-script.md`, `handout.md`, `peer-eval-rubric.md`
- **K트랙 (`py**`) 필수 파일**: `lecture.md`, `lecture-script.md`, `handout.md`, `peer-eval-rubric.md`, `lab.ipynb`
...
### 5. 보조 파일 무결성 스캔 (scripts/)

필요 시 `scripts/` 디렉토리 내의 보조 지침을 활용하여 개별 파일의 무결성을 추가로 스캔하세요:
- `scripts/verify-md.md`: 마크다운 내 미치환 플레이스홀더(`[강사 이름]` 등) 및 문법 오류 검증.
- `scripts/verify-ipynb.md`: `.ipynb` 파일의 JSON 파싱 에러(Silent Error) 점검.
...
| web-output/web-curriculum.md | [O/X] | [PASS/FAIL] |
| python-output/python-curriculum.md | [O/X] | [PASS/FAIL] |
