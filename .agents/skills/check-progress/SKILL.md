...
**E트랙 (wb\*\*) 필수 파일:**
- `lecture.md`, `lecture-script.md`, `handout.md`, `peer-eval-rubric.md`

**K트랙 (py\*\*) 필수 파일:**
- `lecture.md`, `lecture-script.md`, `handout.md`, `peer-eval-rubric.md`, `lab.ipynb`
...
- [x/○] README.md
- [x/○] web-output/web-curriculum.md
- [x/○] python-output/python-curriculum.md
- [x/○] python-output/curriculum-qa-rubric.md

## 2. 웹프로그래밍(E트랙) 진척도
| 주차 폴더 | lecture.md | handout.md | peer-eval | 상태 요약 |
|-----------|------------|------------|-----------|-----------|
| wb01 | ○ | ○ | ○ | 완료 |

## 3. 컴퓨팅적사고와코딩(K트랙) 진척도
| 주차 폴더 | lecture.md | handout.md | lab.ipynb | peer-eval | 상태 요약 |
|-----------|------------|------------|-----------|-----------|-----------|
| py01 | ○ | ○ | ○ | ○ | 완료 |
