...
해당 주차 교육안(`python-curriculum.md`)의 세션별(S1, S2, S3) 세부 내용을 단일 SSOT(Single Source of Truth)로 삼는다.
**구체적인 품질 검증 항목, 감점 기준 및 필수 포함 요소는 반드시 `skills/qa-content` 에이전트의 지침을 100% 준수하여 평가한다.** 각 산출물이 주차 교육안의 내용을 빠짐없이 담고 있는지 검증하고, 누락 시 엄격하게 감점한다.
...
| C-1  | 개념 참고 영역 | 8 | ? | ... |
| C-2  | 실습 섹션 | 5 | ? | ... |
| C-3  | 이메일 과제 내용 (assignment-micro.md 기반) | 7 | ? | ... |
